...
<div id="portfolio" class="portfolio">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-2 text-center">
                <div class="portfolio-item">
                    <a href="#"><img class="img-portfolio img-responsive" src="{{url('/assets/images/portfolio-1.jpg')}}"></a>
                    <h4>Cityscape</h4>
                </div>
            </div>
            <div class="col-md-4 text-center">
                <div class="portfolio-item">
                    <a href="#"><img class="img-portfolio img-responsive" src="{{url('/assets/images/portfolio-2.jpg')}}"></a>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-2 text-center">
                <div class="portfolio-item">
                    <a href="#"><img class="img-portfolio img-responsive" src="{{url('/assets/images/portfolio-3.jpg')}}"></a>
                    <h4>Stop Sign</h4>
                </div>
            </div>
            <div class="col-md-4 text-center">
                <div class="portfolio-item">
                    <a href="#"><img class="img-portfolio img-responsive" src="{{url('/assets/images/portfolio-4.jpg')}}"></a>
                    <h4>Narrow Focus</h4>
                </div>
            </div>
        </div>
